...
class TestBoundaryStationary(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.b2 = [0.0, 2.1, 0.0]
        self.k2 = [0.0, 0.0, 0.4]
        self.bnd = Boundary(self.geometry, self.bcType, self.g, self.a1, self.a2,
                            self.b1, self.b2, self.k1, self.k2)


    def test_init(self):
        d = 3
        bcType = ['dirichlet', 'dirichlet', 'dirichlet']
        g = ['uniform', 'uniform', 'uniform']
        a1 = [0.0, 0.0, 1.0]
        b1 = [0.0, 2.0, 0.9]
        k1 = [-3.0, 0.0, 0.0]
        a2 = [0.0, -1.0, 0.0]
        ...
        self.assertEqual(g[0], self.bnd.g[0])
        self.assertEqual(g[1], self.bnd.g[1])
        self.assertEqual(g[2], self.bnd.g[2])
